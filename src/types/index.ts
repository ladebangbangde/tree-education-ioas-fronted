...
export type Role = 'SUPER_ADMIN' | 'MEDIA' | 'OPERATOR' | 'CONSULTANT' | 'DATA' | 'ADMINISTRATIVE' | 'ANCHOR' | 'IDLE_ANCHOR';
export type Department = '咨询中心' | '申请交付中心' | '文案部' | '签证部' | '媒体部' | '运营部' | '数据部' | '行政部' | '系统管理部' | '主播部';
