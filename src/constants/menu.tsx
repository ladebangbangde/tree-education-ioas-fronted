...
export const menuConfig: AppMenuItem[] = [
  ...
  { key:'cms',label:'内容管理',icon:<ReadOutlined/>,children:[{key:'articles',label:'文章管理',path:'/cms/articles'},{key:'cases',label:'成功案例',path:'/cms/cases'}],roles:['SUPER_ADMIN','OPERATOR','COPYWRITER'] },
  ...
  { key:'settings',label:'系统设置',icon:<SettingOutlined/>,children:[{key:'users',label:'用户管理',path:'/settings/users'},{key:'roles',label:'角色权限',path:'/settings/roles'},{key:'dicts',label:'字典配置',path:'/settings/dicts'},{key:'logs',label:'操作日志',path:'/settings/logs'}],roles:['SUPER_ADMIN','OPERATOR'] }
];
