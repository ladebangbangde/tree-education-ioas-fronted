...
return <><PageHeader title='材料清单'/><SearchFilterBar><Form layout='inline'><Form.Item label='关键词'><Input/></Form.Item><Form.Item label='状态'><Select style={{width:140}} options={[{{value:'跟进中'}}]}/></Form.Item><Button type='primary'>查询</Button><Button>重置</Button></Form></SearchFilterBar><DataTable rowKey='key' columns={cols} dataSource={data} pagination={{total:1}}/></>;
}}
